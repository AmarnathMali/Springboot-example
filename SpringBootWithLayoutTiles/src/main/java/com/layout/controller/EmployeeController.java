...
import com.layout.bean.EmployeeBean;
import com.layout.model.Employee;
import com.layout.service.EmployeeService;
...
public class EmployeeController {
	...
	public ModelAndView deleteEmployee(@ModelAttribute ("command") EmployeeBean employeeBean,BindingResult result) {
		...
		model.put("employee", prepareEmployeeBean(employeeService.getEmployeeById(employeeBean.getId())));
		model.put("employees", prepareListofBean(employeeService.listEmployee()));
		return new ModelAndView("addEmployee",model);
